...
export default class SubpageExplorer {
     ...
     */
    async randomGuessPage(page, maxGuesses, pageCriteria, optionalLinkCriteria) {
    ...
    async findArticle(page) {
        ...
        let guessUrl = await this.randomGuessPage(page, 20, async (page) => {
