...
*/
export declare function injectDOMListener(page: Page): Promise<void>;
/**
 ...
 */
export declare function trackDOMUpdate(page: Page, data: {
    eventType: string;
    elementId: string;
    stack: string;
}): Promise<void>;
 ...
 */
export declare function matchDOMUpdateToAd(page: Page, adHandleToAdId: Map<ElementHandle, number>): Promise<{
    ad_id: number;
    url: string;
    hostname: string;
    type: string;
